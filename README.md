...
| 2 | github-onboarding | [GitHub](https://github.com/susu5/github-onboarding) | 引导用户完成 GitHub 注册 → 创建仓库 → 上传本地代码全流程，含 .gitignore 自动生成脚本 | susu5 | 自建 Skill，首次安装于 2026-06-24 |
