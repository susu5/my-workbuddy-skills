...
- 课中 5Q 直接从【用户基础信息】读取，不新增第三个必需输入；多份 5Q 取更高周频为初步计划，用户改频后以最新实际频率为准
...
| `references/lesson-credit-duration-playbook.md` | 课时额度、周频优先级、周期计算与专属话术规则 |
...
- v02 | 2026-08-24（新增课时额度与完成周期测算能力）
- v01 | 2026-08-22
